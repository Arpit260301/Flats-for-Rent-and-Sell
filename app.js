var express 	 = require("express"),
	...
	//mongodb+srv://ankit-admin:ankit9782@cluster0.uitdy.mongodb.net/myFirstDatabase?retryWrites=true&w=majority
	

mongoose.connect(" mongodb+srv://ankit-admin:ankit9782@cluster0.uitdy.mongodb.net/myFirstDatabase?retryWrites=true&w=majority", {
...
app.post("/properties", isLoggedIn, function(req, res){
	...
	Property.create( newProperty, function(err,allproperty){
		if(err){
			// req.flash("error", err.message);
			res.redirect("/about");
			console.log("Error : "+ err);
